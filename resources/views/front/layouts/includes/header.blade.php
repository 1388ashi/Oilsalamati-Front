        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-6 col-sm-6 col-md-3 col-lg-4 text-right">
              <i class="icon anm anm-phone-l ms-2"></i
              ><a href="tel:401234567890" dir="ltr">09113707857</a>
            </div>
            <div
              class="col-12 col-sm-12 col-md-6 col-lg-4 text-center d-none d-md-block"
            >
              ارسال رایگان برای همه سفارش‌های بالای 99 تومان
              <a href="#" class="text-link me-1">اکنون خرید کنید</a>
            </div>
            <div
              class="col-6 col-sm-6 col-md-3 col-lg-4 text-left d-flex align-items-center justify-content-end"
            >
              <div class="social-email left-brd d-inline-flex">
                <ul
                  class="list-inline social-icons d-inline-flex align-items-center"
                >
      ...
      <header class="header d-flex align-items-center header-1 header-fixed">
        <div class="container">
          <div class="row">
            <!--Logo-->
            <div
              class="logo col-5 col-sm-3 col-md-3 col-lg-2 align-self-center"
            >
            ...
            <!--منو-->
            <div
              class="col-1 col-sm-1 col-md-1 col-lg-8 align-self-center d-menu-col"
            >
              <nav class="navigation" id="AccessibleNav">
                <ul id="siteNav" class="site-nav medium center">
                  ...
                  <li class="lvl1 parent dropdown">
                    <a href="#"
                      >محصولات <i class="icon anm anm-angle-down-l"></i
                    ></a>
                    <ul class="dropdown">
                      <li>
                        <a href="aboutus-style1.html" class="site-nav"
                          >زنانه <i class="icon anm anm-angle-left-l"></i
                        ></a>
                        <ul class="dropdown">
                          <li>
                            <a href="aboutus-style1.html" class="site-nav"
                          ...
                          <li>
                            <a href="aboutus-style2.html" class="site-nav"
                              >کلاه</a
                            >
                          </li>
                        </ul>
            ...
            <!--نماد سمت راست-->
            <div
              class="col-7 col-sm-9 col-md-9 col-lg-2 align-self-center icons-col text-left"
            >
              <!--جستجو-->
              <div class="search-parent iconset">
                ...
                <div
                  class="search-drawer offcanvas offcanvas-top"
                  tabindex="-1"
                  id="search-drawer"
                >
                  <div class="container">
                    <div
                      class="search-header d-flex-center justify-content-between mb-3"
                    >
                    ...
                    <div class="search-body">
                      ...
                      >
                        ...
                        <div class="search-products">
                          <ul
                            class="items g-2 g-md-3 row row-cols-lg-4 row-cols-md-3 row-cols-sm-2"
                          >
                            <li
                              class="item vala w-100 text-center text-muted d-none"
                            >
                              شما هیچ موردی در جستجوی خود ندارید.
                            </li>
                            <li class="item">
                              <div
                                class="mini-list-item d-flex align-items-center w-100 clearfix"
                              >
                                ...
                                <div class="me-3 details text-right">
                                  <div class="product-name">
                                    <a
                                      class="item-title"
                                      href="product-layout1.html"
                                      >پیراهن کوبایی آکسفورد</a
                                    >
                                  </div>
                                  <div class="product-price">
                                    <span class="old-price">114.00 تومان </span
