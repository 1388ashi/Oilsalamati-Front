...
(function ($) {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<span class="ht-count days"><span class="count-inner"><span class="time-count">%-D</span> <span class="text">روز</span></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">%-H</span> <span class="text">ساعت</span></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">%M</span> <span class="text">دقیقه</span></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">%S</span> <span class="text">ثانیه</span></span></span>'));
        });
    });
    ...
    function product_three_loadmore() {
        ...
        $(".loadMore3").on('click', function (e) {
            ...
            if ($(".product-three-loadmore .item:hidden").length == 0) {
                $(".infiniteload").html('<div class="btn btn-lg loadMore3">دیگر محصولی وجود ندارد</div>');
            }
        });
    }
    ...
    function product_four_loadmore() {
        ...
        $(".loadMore4").on('click', function (e) {
            ...
            if ($(".product-four-loadmore .item:hidden").length == 0) {
                $(".infiniteload").html('<div class="btn btn-lg loadMore4">دیگر محصولی وجود ندارد</div>');
            }
        });
    }
    ...
    function product_listview_loadmore() {
        ...
        $(".loadMoreList").on('click', function (e) {
            ...
            if ($(".product-listview-loadmore .item:hidden").length == 0) {
                $(".infiniteload").html('<div class="btn btn-lg loadMoreList">دیگر محصولی وجود ندارد</div>');
            }
        });
    }
    ...
    function blog_listview_loadmore() {
        ...
        $(".loadMore1").on('click', function (e) {
            ...
            if ($(".blog-listview-loadmore .blog-article:hidden").length == 0) {
                $(".infiniteload").html('<div class="btn btn-lg loadMore1">دیگر پست وبلاگ وجود ندارد</div>');
            }
        });
    }
    ...
    function price_slider() {
        $("#slider-range").slider({
            ...
            slide: function (event, ui) {
                $("#amount").val("ت" + ui.values[0] + " - ت" + ui.values[1]);
            }
        });
        $("#amount").val("ت" + $("#slider-range").slider("values", 0) +
                " - ت" + $("#slider-range").slider("values", 1));
    }
    price_slider();
