...
return [
    ...
    'settings' =>[
        [
            ...
            'options' => null,
            'private'   => '0',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ],
        [
            'group'   => 'site',
            'label'   => 'لوگو سایت',
            'name'   => 'logo',
            'type'   => 'image',
            'value'   => 'settings/Xvu5Zk73bSdpD89NMa1CCOyXY0KWarhyaeZWHjgU.png',
            'options' => null,
            'private'   => '0',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
...
راهکارهای متنوعی که دنیای مدرن برای رفع نیازهای روزمره از جمله انتخاب و خرید کالا به افراد پیشنهاد می دهد، باعث افزایش سرعت و دقت در انجام این امور می شود. با این شرایط تازه دیگر کمتر کسی کالایی را بدون تحقیق و بررسی خریداری می کند( سبکی که به جرات می توان گفت به وسیله دیجی‌کالا مرسوم شد ) . مشتریان پیش از خرید هریک از کالاهای مورد نیاز خود، با طیف وسیعی از انتخاب ها مواجه اند و در مقابل آن، به اطلاعات دقیق تری نیازمندند. دقت در ویژگی های هر کالا و دسترسی به اطلاعات صحیح نیاز اساسی مشتریان است. امروزه روش های نوین و هوشمندانه خرید، می تواند به خوبی پاسخگوی نیازهای مشتریان باشد و همین امر موجب شده روزانه افراد بیشتری به جمع استفاده کنندگان سرویس های اینترنتی بپیوندند.',
        ...
        [
            'group'   => 'order',
            'label'   => 'تعداد روز رزو کردن کاربر',
            'name'   => 'reserved_day',
            'type'   => 'integer',
            'value'   => '3',
            'options' => null,
        ...
        [
            ...
            'name'   => 'address',
            'type'   => 'string',
            'value'   => 'استان گلستان -گرگان- خیابان سرخواجه مجتمع  آفتاب۳ طبقه همکف واحد ۹۳',
            'options' => null,
            'private'   => '0',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ...
        [
            ...
            'name'   => 'shop_address',
            'type'   => 'text',
            'value'   => 'گرگان-بخش مرکزی خیابان سرخواجه مجتمع آفتاب۳ طبقه همکف واحد۹۳',
            'options' => null,
            'private'   => '0',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به ارسال شده',
            'name'   => 'delivered_type_sms',
            'type'   => 'multi_select',
            'value'   => 'firebase,database',
            'options' => '["sms","firbase","database"]',
            'private'   => '1',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ],
        [
            'group'   => 'notification',
            'label'   => 'ارسال پیامک زمان تغییر وضعیت به ارسال شده',
            'name'   => 'canceled_type_sms',
            'type'   => 'multi_select',
            'value'   => 'firebase,database,sms',
            'options' => '["sms","firbase","database"]',
            'private'   => '0',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به خطا',
            'name'   => 'failed_type_sms',
            'type'   => 'multi_select',
            'value'   => 'firebase,database,sms',
            'options' => '["sms","firbase","database"]',
            'private'   => '1',
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به رزو شده',
            'name'   => 'reserved_type_sms',
            'type'   => 'multi_select',
            'value'   => 'sms,firbase,database',
            'options' => '["sms","firbase","database"]',
            'private'   => '1',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به درحال پردازش',
            'name'   => 'in_progress_type_sms',
            'type'   => 'multi_select',
            'value'   => 'firbase,database,sms',
            'options' => '["sms","firbase","database"]',
            'private'   => '1',
            'created_at' => '2021-09-09 00:25:03',
            'updated_at' => '2021-09-09 00:25:03'
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به جدید',
            'name'   => 'new_type_sms',
            'type'   => 'multi_select',
            'value'   => 'firbase,database,sms',
            'options' => '["sms","firbase","database"]',
        ...
        [
            'group'   => 'notification',
            'label'   => 'نوع اعلان زمان تغییر وضعیت به در انتظار پرداخت',
            'name'   => 'wait_for_payment_type_sms',
            'type'   => 'multi_select',
            'value'   => 'sms,firbase,database',
            'options' => '["sms","firbase","database"]',
            'private'   => '1',
