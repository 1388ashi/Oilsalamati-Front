...
class ListenDiscountNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase()
    {
        return [
            ...
            'description' => "مشتری عزیز {$this->product->title} شما پیشنهاد ویژه شد."
        ];
    }
    ...
    public function toFirebase($notifiable)
    {
        ...
        $message =  (new FirebaseMessage())
            ->withTitle('پیشنهاد ویژه جدید')
            ->withBody("محصول {$this->product->title} پیشنهاد ویژه شده است.")
