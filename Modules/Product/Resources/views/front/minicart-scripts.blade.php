    ...
    @if (auth()->guard('customer')->user())
        ...
        function updateCartInfo(data) {
            ...
            carts.forEach(function(cart) {
                    ...
                    let imageValue = cart.variety.main_image_showcase?.url ?? cart.variety.product.images_showcase.main_image.url;
                ...
                let totalPriceFormatted = (totalPrice.toLocaleString()) + ' ' + 'تومان'; $('#cart-price').text(
                    totalPriceFormatted);
            }
