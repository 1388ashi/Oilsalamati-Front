...
use Shetabit\Shopit\Modules\Contact\Providers\ContactServiceProvider as BaseContactServiceProvider;
use Modules\Contact\Providers\RouteServiceProvider;
...
//        }
    ...
    {
        if (! app()->environment('production') && AppServiceProvider::$runningInConsole) {
