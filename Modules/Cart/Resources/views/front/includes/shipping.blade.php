          ...
          <div class="address-select-box" id="AddressBox-{{ $address->id }}">
            <div class="address-box bg-block">
              <div class="middle">
                <div class="card-number mb-3">
                  <div class="customRadio clearfix">
                    <input id="formcheckoutRadio-{{ $address->id }}" value="{{ $address->id }}" name="address_id" type="radio" class="radio"/>
          ...
          <div class="address-select-box active">
            <div class="address-box bg-block h-100">
              ...
              <div class="middle">
                <div class="card-number mb-3">
                  <div class="customRadio clearfix">
                    <input id="formcheckoutRadio{{ $loop->iteration }}" value="{{ $shipping->id }}" oninput="test(event)" name="shipping_id" type="radio" class="radio shipping-radio>
                    <label for="formcheckoutRadio{{ $loop->iteration }}" class="mb-2">{{ $shipping->name }}</label>
