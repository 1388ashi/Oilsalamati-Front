        ...
        <div class="row align-items-center">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                <div class="breadcrumbs">
                    ...
                    <span class="main-title fw-bold"><i class="icon anm anm-angle-left-l"></i>سفارش موفقیت</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="page-header text-center">
    <div class="container">
        <div class="row">
            ...
            <div class="page-title"><h1>سفارش موفقیت</h1></div>
                <div class="breadcrumbs">
                    <a href="index.html" title="Back to the home page">صفحه اصلی</a>
                    <span class="main-title"><i class="icon anm anm-angle-left-l"></i>دستور موفقیت</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="success-text checkout-card text-center mb-4 mb-md-5">
        ...
        <p class="mb-1">
            یک ایمیل تأیید سفارش با جزئیات سفارش و پیوندی برای پیگیری پیشرفت
            آن دریافت خواهید کرد.
        </p>
        <p class="text-order badge bg-success mt-3">
            شناسه تراکنش: {{$order->id}}
        </p>
    </div>
    <!--End Order success-->
    ...
    <div class="row checkout-form">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
            ...
            <div class="cart-order-detail cart-col">
                ...
                <span
                    ...
                    ><span class="money">326 هزار</span></span
                >
                </div>
                ...
                <span
                    class="col-6 col-sm-6 cart-subtotal-title cart-subtotal text-end"
                    ><span class="money">-25 هزار</span></span
                >
                </div>
                <div class="row g-0 border-bottom py-2">
                <span class="col-6 col-sm-6 cart-subtotal-title"
                ...
                <span
                    class="col-6 col-sm-6 cart-subtotal-title cart-subtotal text-end"
                    ><span class="money">10 هزار</span></span
                >
                </div>
                <div class="row g-0 border-bottom py-2">
                <span class="col-6 col-sm-6 cart-subtotal-title"
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
            ...
            <a
                href="index.html"
                class="d-inline-flex align-items-center btn btn-outline-primary me-2 mb-2 me-sm-3"
                ><i class="me-2 icon an-angle-left-r"></i>به خرید ادامه
                دهید</a
            >
            <button
                type="button"
                class="d-inline-flex align-items-center btn me-2 mb-2 me-sm-3"
            >
                <i class="me-2 icon an-print"></i>سفارش چاپ
            </button>
            <button
                type="button"
                class="d-inline-flex align-items-center btn me-2 mb-2 me-sm-3"
            >
                <i class="me-2 icon an-sync-ar"> </i>سفارش مجدد
            </button>
            </div>
            <!--Order delivery-->
        </div>
