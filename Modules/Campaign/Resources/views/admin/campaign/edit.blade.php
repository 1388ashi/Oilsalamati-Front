...
@section('content')
    <div class="page-header">
        @php($items = [['title' => 'لیست کمپین ها', 'route_link' => 'admin.campaigns.index'], ['title' => 'ویرایش کمپین ']])
    ...
    <x-card>
        ...
        <x-slot name="cardBody">
            ...
            <form action="{{ route('admin.campaigns.update', $campaign) }}" method="POST" class="save"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="title" class="form-control" name="title"
                                placeholder="عنوان را وارد کنید" value="{{ old('title', $campaign->title) }}" required
                                autofocus />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="	coupon_code" class="form-control" name="	coupon_code"
                                placeholder="عنوان را وارد کنید" value="{{ old('coupon_code', $campaign->coupon_code) }}"
                                autofocus />
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input name="end_date" id="from_end_at_hide" type="hidden"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="customer_title" class="form-control" name="customer_title"
                                placeholder="عنوان مشتری را وارد کنید"
                                value="{{ old('customer_title', $campaign->customer_title) }}" required autofocus />
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="customer_text" class="form-control" name="customer_text"
                                ...
                                value="{{ old('customer_text', $campaign->customer_text) }}" autofocus />
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <label class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="status" value="1"
                                {{ old('status', $campaign->status) == 1 ? 'checked' : null }} />
                ...
                <div class="row">
                    <div class="col">
                        <div class="text-center">
                            ...
                            <a class="btn btn-outline-danger" href="{{ route('admin.campaigns.index') }}">برگشت</a>
                        </div>
                    </div>
                </div>
            </form>
